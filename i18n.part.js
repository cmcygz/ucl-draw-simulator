...
const I18N = {
  en: {
    ...
    'saves.meta': 'seed {seed} · {matches} matches · {picks} predictions · {date}',
    'saves.open': 'Open',
    'saves.link': 'Link',
    'saves.delete': 'Delete',
    'saves.opening': 'Opening the save…',
    'saves.openingShared': 'Opening the shared save…',
    'saves.opened': 'Opened: {name} · seed {seed} · {matches} matches',
  ...
  tr: {
    ...
    'saves.meta': 'tohum {seed} · {matches} maç · {picks} tahmin · {date}',
    'saves.open': 'Aç',
    'saves.link': 'Link',
    'saves.delete': 'Sil',
    'saves.opening': 'Kayıt açılıyor…',
    'saves.openingShared': 'Paylaşılan kayıt açılıyor…',
    'saves.opened': 'Açıldı: {name} · tohum {seed} · {matches} maç',
